package com.bitsco.vks.category;
...
public class VksCategoryApplication {

    public static void main(String[] args) {
        Environment env = SpringApplication.run(VksCategoryApplication.class, args).getEnvironment();
